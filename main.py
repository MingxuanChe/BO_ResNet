...
from resnet.resnet import ResNet, create_data_loader, \
                          train_restnet_with_lr, \
                          visualize_classification_results 
from helper import set_seed, device, task_config, Options

def main(config: Options):
    '''Main function to run the Bayesian Optimization for ResNet hyperparameter tuning.
    ...
    NOTE: The learning rate search space is set to be between 1e-5 and 1.0, in which
    applying a log10 transformation makes more sense. Therefore, the log10 transformation
    is applied as in helper.py -> task_config (Options)
    '''
    ...
    print(f'Bayesian Optimization took {bo_end_time - bo_start_time:.2f} seconds')
    ...
    # print(f're-training the ResNet with the best learning rate: {best_lr:.5f}') 
...
if __name__ == '__main__':
    ...
    print('Running Bayesian Optimization for ResNet with log10 transformation for learning rate...')
    ...
    print('Running Bayesian Optimization for ResNet without log10 transformation for learning rate...')
